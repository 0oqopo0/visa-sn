...
import UserManagementPageA from "../Pool/Images/Pub/UserManagementPageA.jpg"; // مسیر تصویر پسزمینه
...
function UserManagementPage() {
  ...
  return (
    <motion.div
      ...
      style={{ backgroundImage: `url(${UserManagementPageA})` }} // اضافه کردن تصویر پسزمینه
      initial="hidden"
      animate="visible"
    ...
    >
      <ToastContainer />
      <motion.div
        className="relative bg-green-400 bg-opacity-30 backdrop-filter backdrop-blur-lg p-8 rounded shadow-md w-full max-w-4xl border border-sky-400"
        initial="hidden"
        animate="visible"
        variants={containerVariants}
      >
