  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative bg-[#EEEDDE]/90 dark:bg-[#2C3333]/80 bg-opacity-30 backdrop-filter backdrop-blur-lg p-2 rounded shadow-md w-full max-w-4xl border border-sky-400 mt-32 mb-28"
        initial="hidden"
        animate="visible"
  ...
  <DataGrid
    ...
    sx={{
      ...
      "& .MuiDataGrid-row:nth-of-type(odd)": {
        backgroundColor: "#EEEDDE", // سبز کم‌رنگ برای ردیف‌های فرد
      },
      "& .MuiDataGrid-row:nth-of-type(even)": {
        backgroundColor: " bg-[#EEEDDE]/90 dark:bg-[#2C3333]/80 bg-opacity-30", // سفید برای ردیف‌های زوج
