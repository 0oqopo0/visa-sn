  ...
  return (
    ...
    >
      ...
      <m.div
          ...
          // className="flex items-center justify-start relative text-3xl  p-3 rounded-full bg-black shadow-[inset_3px_2px_109px_-59px_rgba(255,255,255,0.43)]"
          >
        {mobileMenu ? (
      ...
      {/* ////////////// Search in lg TODO //////////////// */}
      {/*////////////////////////////////////////////////// */}
     <m.div className="flex ml-10 p-3 h-full w-full justify-center items-center text-2xl md:text-4xl lg:text-4xl text-gray-600 dark:text-yellow-600 font-Gabriola "
