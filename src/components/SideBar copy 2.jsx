          ...
          <>
            ...
            >
                ...
                <div
                  ...
                  className={`fixed  z-50 ml-4 mt-2 mb-2 mr-2 text-sm rounded-full hover:bg-gray-500/60 p-3 dark:text-red-600 ${
                    isOpen ? "bg-green-300 right-[50%]" : "bg-red-400 right-[-0%]"
                    }`}
                  onClick={clearInput}
                >
                  <FaEraser
