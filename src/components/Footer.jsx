...
const Footer = () => (
  <div className="flex  justify-between fixed h-20 md:h-24 lg:h-24 w-full text-sky-500 text-sm bg-white/80 dark:bg-black/90 items-center border-t-2 border-sky-500 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)]"
  // style={{ zIndex: "50" }}
  // style={{ zIndex: "1000" }}
  >
    {/* Company Information */}
    ...
    <div className=" flex-1 flex-col justify-center items-center ">
      ...
      >
        <a
          ...
          target="_blank"
        >
          <p className="font-Gabriola text-xl">0oqopo0</p>
          <AiFillGithub />
        </a>
      </a>
      ...
      >
        <a
          ...
          target="_blank"
        >
          <p className="font-Gabriola text-xl">SourceCode </p>
          <AiFillGithub />
        </a>
      </a>
    </div>
