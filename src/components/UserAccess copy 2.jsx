      ...
      {isAdmin && (
        ...
        >
          <motion.div
            ...
            className="  flex items-center justify-center font-semibold bg-[#EEEDDE]/90 dark:bg-[#2C3333]/80 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)]     h-24 p-2  text-green-800    text-md "
