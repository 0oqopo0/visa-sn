...
console.log("isOpen : " + isOpen);
  return (
    ...
    <>
      ...
      <div className="flex pr-3 text-2xl gap-2  justify-end items-center font-bold border-b-2 border-b-gray-800 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)] rounded-sm " onClick={toggleMenu}>
        ...
        {isMenuOpen && (
          ...
          >
            {route.subItem.map((subRoute, i) => (
              ...
              >
                <NavLink to={subRoute.eName} className="w-[98%] flex p-3 text-2xl gap-2  justify-end items-center font-bold border-b-2 border-b-gray-800 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)] rounded-tr-lg">
