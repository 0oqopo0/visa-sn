    ...
    <>
      ...
      <div className="">
        ...
        <motion.div
          ...
          className=" fixed mt-24 z-50 w-[50%]  h-[65%] md:h-[70%] lg:h-[70%] bg-[#EEEDDE]/70 text-sm dark:bg-[#2C3333]/80 overflow-y-scroll rounded-br-lg"
        ...
        >
          ...
          <>
            <div
              ...
              className="flex mb-1 mt-2 mr-1 text-sm  bg-[#18291c] text-sky-800 dark:text-sky-500  items-center justify-between gap-3   text-md  rounded-br-sm rounded-tr-sm "
              // className=""
              // style={{ zIndex: "1000" }}
            ...
            >
              ...
              <input
                dir="rtl"
                className="w-full  bg-black/60  m-2  text-green-500 dark:text-red-500  flex items-center gap-3  text-xl md:text-2xl lg:text-2xl border-solid  border-1  border-gray-600 p-3 text-center mr-2"
                id="searchTerm"
                name="searchTerm"
                value={searchTerm}
                type="text"
                  ...
                  <div className="" key={val.id}>
                    <p className="">
                      <NavLink
                        ...
                        className=" text-black dark:text-yellow-500 bg-green-700/50 dark:bg-green-400/50  hover:bg-green-800/40   dark:hover:bg-green-800/70 flex items-center justify-between gap-3  mb-1  text-2xl  rounded-sm border-b-1 border-b-yellow-800 mr-2 ml-1 p-2 "
