...
useEffect(() => {
  const checkAuth = () => {
    ...
    const adminStatus = UserService.isAdmin();handleLogout
      ...
      <div className="">
        ...
        >
          ...
          <>
            ...
            >
              <div
                className="ml-4 mt-2 mb-2 mr-2 text-sm rounded-full bg-black/90 hover:bg-gray-500/60 p-3  dark:text-red-600 "
                onClick={clearInput}
              >
                <FaEraser
                  className={
