    ...
    <>
      {/* <div className="bg-green-500/40 mt-24 w-[90%] fixed z-50 h-[80%]"> */}
        ...
        <motion.div
          ...
          className=" fixed mt-24 p-1 z-50  h-[70%] bg-white text-red dark:bg-black/90 overflow-y-scroll rounded-br-lg "
        >
          {/* ///////////////////////////////////////////// */}
          {/* ////////////////// Search /////////////////// */}
          {/*////////////////////////////////////////////// */}
                ...
                return (
                  <div className="" key={val.id}>
                    <NavLink
                      ...
                      className="flex-1 text-black dark:text-red-500 bg-red-400  hover:bg-green-800/40   dark:hover:bg-green-800/70 flex items-center justify-between gap-3  mb-1  text-2xl p-2  transition ease-in-out delay-3  hover:-translate-y-.5 hover:scale-105  rounded-sm border-b-1 border-b-yellow-800 "
                      // className="flex-1 text-black dark:text-red-500 bg-red-400  hover:bg-green-800/40   dark:hover:bg-green-800/70 flex items-center justify-between gap-3  mb-1  text-2xl p-2  transition ease-in-out delay-3  hover:-translate-y-.5 hover:scale-105  rounded-sm border-b-1 border-b-yellow-800 "
                    >
                      {val.flag != null ? val.flag : val.icon}
