        ...
        <BrowserRouter>
          <div className="flex flex-col">
            ...
            <m.div
              ...
              className={` flex justify-center  items-center fixed w-[45px] h-12 mb-2 right-[0%] bottom-[10%] shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)] text-4xl dark:bg-black/80 bg-white/90 '
           ${
             contact
