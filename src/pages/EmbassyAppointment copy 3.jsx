  ...
  return (
    <div className="mt-24 h-screen w-full ">
      ...
      >
        ...
        <div className=" bg-yellow-100 p-[15%]">

          {/* carousel */}
          <m.div className=" cursor-grabbing overflow-hidden">
            
            {/* inner-carousel */}
            <m.div drag="x" dragConstraints={{right:0}} className=" rounded-3x bg-purple-500  w-full flex">
              {images.map(image =>{
                return(

                  // item
                  <m.div className="flex min-h-[25rem] min-w-[20rem]  m-2 rounded-3xl ">
                    <img class Name="w-[100%] h-[100%] rounded-3xl pointer-event-none" src={image} alt=""/>
                  </m.div>
                );
              }
