...
<m.div
        ...
        className="flex flex-col h-full py-2  px-2   group bg-white dark:bg-[#222831]  "
      >
<div className="mt-2  md:max-w-[100%] lg:max-w-[100%] px-2 h-[100%]">
...
{/*/////////////////////// Arrow BTN ///////////////////////////// */}
        ...
        <div
          className="  absolute top-[40%] md:top-[55%] lg:top-[55%]  right-[45%] text-2xl rounded-full p-2 bg-red-500/40 text-white cursor-pointer duration-500 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)] animate-pulse z-10"
          onClick={function (event) {
            handleDescription();
          }}
          ...
          {Data.map(
            (data, i) =>
              ...
              data.subItem.map((item, i) => (
                <SwiperSlide key={i}>
                   <div
                    className="h-screen   flex flex-col justify-between  bg-center bg-cover duration-700 border-b-1 border-l-1 border-r-1  border-gray-600   rounded-lg"
