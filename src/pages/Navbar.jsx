...
const Navbar = () => {
  ...
  return (
    ...
    className="flex fixed w-full justify-between items-center bg-white/90 dark:bg-red-500/90  px-4  z-30   h-24   border-solid  border-b-1  border-sky-500 shadow-[inset_0_5px_26px_rgba(0,0,0,0.6)]">
      {/* //////////////////////////////////////////// */}
      {/* ////////////// MobileMenu BTN ////////////// */}
      {/*///////////////////////////////////////////// */}
      <div
      ...
      >
        {mobileMenu ? (
          <CgMenuRightAlt className=" text-green-400 " />
        ) : (
      ...
      <div className=" border-color  flex ">
        ...
        <div className="flex flex-col gap-2">
          <GiSunflower
            className="text-lg  text-yellow-800 dark:text-gray-500  shadow-2xl ...  mt-2 mr-2"
